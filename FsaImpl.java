...
public class FsaImpl implements Fsa, FsaSim {
    ...
    public boolean isRecognised() {
        ...
        while (inputEvents.hasNext()) {
            ...
            //recognised is a boolean that determines if an input has been recognised.
            boolean recognised = false;
            Iterator transitionIt = this.transitions.iterator();
            //Iterate over each transition, until the input is recognised.
            while (transitionIt.hasNext() && recognised == false) {
